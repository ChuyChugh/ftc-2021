...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double X_MULTIPLIER = 0.9984399375975039; // Multiplier in the X direction
    public static double Y_MULTIPLIER = 1.00931862868665; // Multiplier in the Y direction
